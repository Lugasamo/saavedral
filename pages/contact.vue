<template>
  <div class="md-layout md-gutter md-alignment-center">
    <div class="contact md-layout-item md-size-60 md-alignment-centered" id="contact">
    ...
    <div class="form-message" v-else-if="submitted === 1">
      ...
      <a href="tel:+61386096966" class="btn btn-lg button__call_lg"></span>+61 3 8609 6966</a>
    </div>
    ...
    <div class="form-message" v-else>
      ...
      <a href="tel:+61386096966"></span>+61 3 8609 6966</a>
      <p>
